...
box_id = p.loadURDF("./forest/forest.urdf",baseOrientation=p.getQuaternionFromEuler([1.57,0,0]), basePosition=[0, 0, 0],useFixedBase=True)  # Replace with a box URDF if needed


drone_id = p.loadURDF('./cf2/cf2.urdf', basePosition=[0, 0, 1],baseOrientation=p.getQuaternionFromEuler([1.57,0,0]),globalScaling=3)
